  ...
  return (
    <div className={`space-y-6 md:space-y-8 ${ANIMATION_CLASS}`}>
      <div className="bg-slate-800/40 backdrop-blur-md p-5 md:p-10 rounded-3xl md:rounded-[2.5rem] border border-slate-700/50 shadow-2xl relative overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[250px] md:w-[500px] h-[250px] md:h-[500px] bg-purple-500/10 blur-[60px] md:blur-[120px] rounded-full pointer-events-none"></div>

        <div className="flex items-center gap-5 mb-5 md:mb-8 relative z-10">
          <div className="p-3 md:p-4 bg-gradient-to-br from-purple-500/20 to-pink-500/20 text-purple-400 rounded-xl md:rounded-2xl border border-purple-500/20 shadow-[0_0_15px_rgba(168,85,247,0.2)]">
            <RefreshCcw className="size-7 md:size-9" />
          </div>
          <h2 className="text-xl md:text-3xl font-bold tracking-tight text-white">完美的陷阱：耐受与戒断</h2>
        </div>
        <p className="text-slate-300 leading-relaxed text-sm md:text-lg mb-10 md:mb-12 relative z-10">
        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 relative z-10">
            <div className="bg-slate-900/90 p-5 md:p-8 rounded-2xl md:rounded-3xl border border-slate-700/80 shadow-xl relative group md:hover:-translate-y-2 transition-transform duration-500">
              ...
              <h3 className="text-lg md:text-2xl font-bold mb-4 text-blue-400 mt-6 md:mt-2">耐受性建立</h3>
            ...
            <div className="bg-slate-900/90 p-5 md:p-8 rounded-2xl md:rounded-3xl border border-slate-700/80 shadow-xl relative group md:hover:-translate-y-2 transition-transform duration-500">
              ...
              <h3 className="text-lg md:text-2xl font-bold mb-4 text-yellow-400 mt-6 md:mt-2">戒断反应</h3>
              <p className="text-slate-400 leading-relaxed">
            ...
            <div className="bg-slate-900/90 p-5 md:p-8 rounded-2xl md:rounded-3xl border border-slate-700/80 shadow-xl relative group md:hover:-translate-y-2 transition-transform duration-500">
              ...
              <h3 className="text-lg md:text-2xl font-bold mb-4 text-red-400 mt-6 md:mt-2">虚假的"解压"</h3>
              <p className="text-slate-400 leading-relaxed">
        ...
        <div className="mt-10 md:mt-12 bg-gradient-to-r from-slate-900 to-slate-800 p-5 md:p-8 rounded-xl md:rounded-2xl border border-slate-700 shadow-inner relative z-10 flex items-center gap-4 md:gap-6">
