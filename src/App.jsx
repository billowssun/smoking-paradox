...
const TAB_ICONS = {
  brain: <Brain size={18} />,
  body: <ShieldAlert size={18} />,
  cycle: <RefreshCcw size={18} />,
  psychology: <Users size={18} />,
  ecig: <CloudFog size={18} />,
  longterm: <AlertTriangle size={18} />,
  calculator: <Calculator size={18} />,
  quit: <Hourglass size={18} />,
};
      ...
      <div className="relative z-10">
        ...
        <footer className="border-t border-slate-800/50 bg-slate-900/30 backdrop-blur-sm py-12 text-center text-slate-500">
          <div className="max-w-4xl mx-auto px-6">
            ...
            <p className="text-sm opacity-50 mb-4">交互式医学科普演示 · 抽烟的悖论</p>
            <div className="text-xs opacity-30 max-w-lg mx-auto leading-relaxed">
